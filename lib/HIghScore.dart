  ...
  void _confirmClear(BuildContext ctx) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text('Clear All Scores?', style: CD.label(16, CD.red, ls: 1)),
        content:
        Text('This cannot be undone.', style: CD.body(13, Colors.white54)),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(ctx),
              child:
              Text('CANCEL', style: CD.label(13, Colors.white54))),
          TextButton(
              onPressed: () async {
                await ScoreService.clearScores();
                if (mounted) setState(() => _scores.clear());
                Navigator.pop(ctx);
              },
          ...
          child: Column(
            children: [
              ...
              if (_loading)
                const Expanded(
                  child: Center(
                    child: CircularProgressIndicator(color: CD.cyan),
                  ),
                )
              else ...[
                // ── Best score banner ──
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.sports_esports_rounded,
                            color: CD.cyan.withOpacity(0.3), size: 72),
                        const SizedBox(height: 20),
                        Text('No scores yet',
                            style: CD.label(16,
